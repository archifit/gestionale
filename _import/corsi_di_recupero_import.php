...
// console_log_data("query=", "$query");
	...
	$fileName = "D:/Workspace/MySql Model/gestionale.import/CorsiDiRecupero-Import.csv";
...
";
	...
	$retval = file_put_contents("D:/Workspace/MySql Model/gestionale.import/CorsiDiRecupero-Import.txt", $message);

	$retval = file_put_contents("D:/Workspace/MySql Model/gestionale.import/CorsiDiRecupero-Import.sql", $sqlContent);
