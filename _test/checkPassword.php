...
echo 'e50dc404eaf93f31a66573ed4e5f4bca';
echo '</br>';
echo passwordHash('Ufficiodocenti@01');
echo '</br>';
echo passwordHash('UfficioDocenti@01');
echo '</br>';
echo passwordHash('ufficiodocenti@01');
...
<input type="text" id="foo2"
   onchange="document.getElementById('output2').innerHTML = MD5(this.value);"/>

<div id="output2">md5 output will be here</div>
