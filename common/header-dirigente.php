...
<nav class="navbar navbar-default navbar-fixed-top top-navbar top-navbar-default">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav top-navbar-nav">
			...
			<a href="<?php echo $__application_base_path; ?>/dirigente/quadroOreDovute.php" class="btn btn-default navbar-btn btn-success" role="button"><span class="glyphicon glyphicon-time"></span>&ensp;Ore Dovute </a>
