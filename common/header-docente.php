...
<nav class="navbar navbar-default navbar-fixed-top top-navbar top-navbar-default">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav top-navbar-nav">
			...
			<a href="<?php echo $__application_base_path; ?>/docente/interventoDidattico.php" class="btn btn-default navbar-btn btn-info" role="button"><span class="glyphicon glyphicon-list-alt"></span>&ensp;Interventi didattici </a>
			<a href="<?php echo $__application_base_path; ?>/docente/previste.php" class="btn btn-default navbar-btn btn-success" role="button"><span class="glyphicon glyphicon-user"></span>&ensp;Attività con Studenti </a>
			<a href="<?php echo $__application_base_path; ?>/docente/ore80.php" class="btn btn-default navbar-btn btn-warning" role="button"><span class="glyphicon glyphicon-time"></span>&ensp;80 Ore</a>
		...
		<ul class="nav navbar-nav navbar-right top-navbar-nav">
			...
			<li>
			<?php if ($ruolo_dirigente) echo '<a href='.$__application_base_path.'/dirigente/selezionaDocente.php><span class="glyphicon glyphicon-log-out"></span></a>' ?>
			</li>
		</ul>
	</div>
</nav>
